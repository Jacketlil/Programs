...
//		}
		...
		//	g.setColor(backColour);
			...
			if (dragging) {				
				/* If you just try and draw a white rectangle, 
				 * it erases all other rectangles too. Use XOR mode */
